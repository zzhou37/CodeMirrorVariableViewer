...
One Part IS MY PROJECT: Language: HTML, CSS, javaScript, got good grade on this project
Open Index.html
Click Home.
Click other Demo.
Click Show Variables. (this is what I extended)
You can see two text boxes, one is for code. One is for the input the value of variable, manuly updated.
